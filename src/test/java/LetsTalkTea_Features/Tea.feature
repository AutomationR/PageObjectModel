...
Feature: LetsTalkTea
  ...
  #
      ...
      #
         #@LetsTalkTea_Menu
  #Scenario: Lets TalkTea_Menu
  #
      #Given Launch  chrome browser and enter the URL
      #When Click on the our menu link
#		  And Click on GreenTea Checkout
      #And Click on RedTea Checkout
      #And Click on ooLongTea Checkout
      #
         #@LetsTalkTea_Passion
  #Scenario: Lets TalkTea_Passion
  #
      #Given Launch  chrome browser and enter the URL
      #When Click on the our passion link
      #And Scroll the page
      #
      #@LetsTalkTea_Passion
  #Scenario: Lets TalkTea_Welcome
  #
      #Given Launch  chrome browser and enter the URL
      #When Click on the welcome link
      #And Click on all three see collections link
      #And Click on seleniumframework.com  link
      #
